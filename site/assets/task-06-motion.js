(() => {
  ...
  entrance
    ...
    .from(".screen-instrument", { x: 38 }, "-=0.7")
    .from(".hero-controls > *", { y: 24, stagger: 0.06 }, "-=0.54")
  ...
  const revealGroups = [
    ...
    },
    {
      ...
      selectors: [
        ".validation-section .section-introduction > *",
        ".validation-laboratory",
      ],
      y: 42,
    },
    {
      trigger: ".domain-section",
      selectors: [
        ".domain-section .section-introduction > *",
        ".order-domain article",
        ".radius-figure",
      ],
      y: 38,
    },
  ...
  window.addEventListener("task06:ready", () => ScrollTrigger.refresh(), {
    once: true,
  });
