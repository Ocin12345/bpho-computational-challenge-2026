# Task 4 Presentation — Photoelectric Effect

This folder contains the finished one-slide Task 4 competition package,
standardized for the final Tasks 1–10 presentation.

## Final deliverables

- [PowerPoint](Task04_Photoelectric_Effect.pptx) — one 16:9 slide with speaker notes and meaningful
  image alternative text.
- [300-DPI preview](preview/Task04_Photoelectric_Effect_preview.png) — 4001 × 2250 pixels.
- [Embedded 4K summary](images/06_task04_summary.png) — byte-identical to the
  [validated source](../../figures/task04/task04_summary.png).
- [Final task narration](SPEAKER_SCRIPT.md) and [visible-content
  record](SLIDE_CONTENT.md).
- [Presentation validator](validate_task04_presentation.py).
...
```bash
npm ci
node build_task_presentations.js 4
bash render_task_previews.sh
python3 task04/validate_task04_presentation.py
```

The current scientific regression suite contains 149 passing Task 4
